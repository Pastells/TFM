...
def show_parameters(PP, run):
    ...
    logging.info("Max_ell                = %f", PP.ell_max)
    logging.info("N_HD                   = %f", PP.N_HD)
    logging.info("N_OD                   = %f", PP.N_OD)
    logging.info("N_ID                   = %f", PP.N_ID)
    logging.info("N_Fourier              = %f", PP.N_Fourier)
